...
<html lang="en" dir="ltr">
  ...
  <div class="workers">
    <form class="" action="add_worker.php" method="post">
      <input class = "t" type="text"  name="n" placeholder="nombre (s)">
      <input class = "t" type="text"  name="ap" placeholder="apellido_paterno">
      <input class = "t" type="text"  name="am" placeholder="apellido_materno">
      <input class = "t" type="number" name="h" placeholder="horas trabajadas">
